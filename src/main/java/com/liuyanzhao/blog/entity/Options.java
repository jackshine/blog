...
public class Options {
    ...
    public void setOptionSiteTitle(String optionSiteTitle) {
        this.optionSiteTitle = optionSiteTitle == null ? null : optionSiteTitle.trim();
    }
    ...
    public void setOptionMetaDescrption(String optionMetaDescrption) {
        this.optionMetaDescrption = optionMetaDescrption == null ? null : optionMetaDescrption.trim();
    }
    ...
    public void setOptionAboutsiteTitle(String optionAboutsiteTitle) {
        this.optionAboutsiteTitle = optionAboutsiteTitle == null ? null : optionAboutsiteTitle.trim();
    }
    ...
    public void setOptionAboutsiteContent(String optionAboutsiteContent) {
        this.optionAboutsiteContent = optionAboutsiteContent == null ? null : optionAboutsiteContent.trim();
    }
    ...
    public void setOptionAboutsiteWechat(String optionAboutsiteWechat) {
        this.optionAboutsiteWechat = optionAboutsiteWechat == null ? null : optionAboutsiteWechat.trim();
    }
    ...
    public void setOptionAboutsiteQq(String optionAboutsiteQq) {
        this.optionAboutsiteQq = optionAboutsiteQq == null ? null : optionAboutsiteQq.trim();
    }
    ...
    public void setOptionAboutsiteGithub(String optionAboutsiteGithub) {
        this.optionAboutsiteGithub = optionAboutsiteGithub == null ? null : optionAboutsiteGithub.trim();
    }
